...
export interface Tour {
  ...
  /**
   * Bókun activity ID for live availability and booking sync
   */
  ...
  gallery?:
    ...
    | null;
  /**
   * Required before publishing — used on tour cards and detail hero.
   */
...
export interface Booking {
  ...
  tour: number | Tour;
  status: 'pending' | 'reserved' | 'confirmed' | 'cancelled' | 'refunded' | 'failed';
  customer: {
    firstName: string;
    lastName: string;
    email: string;
...
export interface BlogPost {
  ...
  status?: ('draft' | 'published') | null;
  /**
   * Optional. Leave empty to save without a publish date.
   */
